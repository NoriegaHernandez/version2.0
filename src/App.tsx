...
// // src/App.tsx
// import { useState } from 'react';
// import { BarChart3, Users, Upload, FileText, Plus, GraduationCap, Settings, LogOut, Shield } from 'lucide-react';
...
// type View = 'dashboard' | 'students' | 'analysis' | 'import' | 'reports' | 'setup' | 'users';
...
//       {showStudentForm && profile.role === 'teacher' && (
//         <StudentForm
//           onSuccess={() => {
//             setShowStudentForm(false);
//             setCurrentView('students');
...
type View = 'dashboard' | 'students' | 'analysis' | 'import' | 'reports' | 'setup' | 'users' | 'profile' | 'grades';
